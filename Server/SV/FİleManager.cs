        ...
        private void indirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems[0].ImageIndex != 0 && listView1.SelectedItems[0].ImageIndex != 13)
            {
                try
                {
                    ...
                    if (ident != null)
                    {
                        string id = listView1.SelectedItems[0].Text + "|" + Environment.CurrentDirectory + "\\Klasörler\\İndirilenler\\" + ident.identify;
        ...
        private void indirToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            if (listView2.SelectedItems[0].ImageIndex != 0 && listView2.SelectedItems[0].ImageIndex != 13)
            {
                try
                {
                    ...
                    if (ident != null)
                    {
                        string id = listView2.SelectedItems[0].Text + "|" + Environment.CurrentDirectory + "\\Klasörler\\İndirilenler\\" + ident.identify;
                        if (((Form1)Application.OpenForms["Form1"]).FindYuzdeById(id) == null)
                        {
